...
N <- 100000
# Number of points
points <- seq(500,500,100)
# Epsilon
epsilons <- seq(0.00008,0.00008, 0.0002)
...
cluster_1 <- cluster_coordinates[cluster_coordinates$ds.cluster==1,c('latitude','longitude')]
plot(cluster_1)
cluster_2 <- cluster_coordinates[cluster_coordinates$ds.cluster==2,c('latitude','longitude')]
plot(cluster_2)
cluster_3 <- cluster_coordinates[cluster_coordinates$ds.cluster==3,c('latitude','longitude')]
plot(cluster_3)
cluster_4 <- cluster_coordinates[cluster_coordinates$ds.cluster==4,c('latitude','longitude')]
plot(cluster_4)
cluster_5 <- cluster_coordinates[cluster_coordinates$ds.cluster==5,c('latitude','longitude')]
plot(cluster_5)
